...
<html>
    ...
    <body>
      ...
      <section class="top-section" style="background-image: url(images/cover/corporativos.jpg)">
        <div class="parallax-overlay">
          <div class="centrize">
            <div class="v-center">
              <div class="container">
                <div class="main-title">
                  <h1>Paquetes corporativos</h1>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="main-description">
            <div class="title">
              ...
              <p>Nuestro equipo de trabajo busca y obtiene las mejores condiciones tanto de precios como de conexiones cómodas de vuelos y estancia en hoteles de acuerdo a las necesidades y política de viaje de cada empresa. En los casos de seminarios, convenciones y congresos internacionales también nos ocupamos de las inscripciones del participante.</p>
            </div>
          </div>
          <div class="title">
