        ...
        <div id="frame">
            <div class="content-frame">
                <div class="article-form">
                    <form action="hrg" to="dasrob@gmail.com" subject="Hola" generic="true">
	                        ...
	                        <div class="form-row">
	                            <div class="col-sm-6">
	                                <div class="form-group">
	                                    <input type="text" placeholder="Nombre y Apellido" class="form-control" name="nombre" mandatory="true"/>
	                                </div>
	                            </div>
	                            <div class="col-sm-6">
	                                <div class="form-group">
